---
title: Officer
description: Reload and shoot the killers!
...
| Officer Can only Shoot Players That Have Killed |        Determines whether the Officer can only shoot a player that has killed someone.        | Toggle  |  True   | True / False |
