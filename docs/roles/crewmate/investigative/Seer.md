...
| Can Reveal/Compare More Than Once Per Round    | Determines whether the Seer can use their abilities more than once per round. | Toggle  |  False  | True / False |

### Compare Alignments Settings
...
| Can Only Compare Each Player Once       | Determines whether the Seer can only compare players once. | Toggle |  False  | True / False |

### Check (Reveal) Alignments Settings

| Option                           | Description                                                                |  Type  | Default |    Range     |
| -------------------------------- | -------------------------------------------------------------------------- | :----: | :-----: | :----------: |
| ┣ Crewmate Killing Roles are Red | Determines if the names of Crewmate Killing roles will show as red when revealed.        | Toggle |  False  | True / False |
| ┣ Neutral Benign Roles Are Red   | Determines if the names of Neutral Benign roles will show as red when revealed.        | Toggle |  False  | True / False |
| ┣ Neutral Evil Roles Are Red     | Determines if the names of Neutral Evil roles will show as red when revealed.        | Toggle |  False  | True / False |
| ┣ Neutral Killing Roles Are Red  | Determines if the names of Neutral Killing roles will show as red when revealed.        | Toggle |  True   | True / False |
| ┣ Neutral Outlier Roles Are Red  | Determines if the names of Neutral Outlier roles will show as red when revealed.        | Toggle |  False  | True / False |
