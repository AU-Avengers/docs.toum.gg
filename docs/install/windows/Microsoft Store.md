...
This guide requires that you own _Among Us_ on [Microsoft Store / Xbox App](https://apps.microsoft.com/detail/9NG07QJNK38J).
...
>
> **4.** Go to the `Content` folder within _Among Us_.
>
