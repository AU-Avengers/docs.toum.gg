...
| Door Type on Skeld                |                       Determines which type of doors are enabled.                        |   String   |   Skeld   | Skeld / Polus / Airship / Fungle / Submerged / No Doors (removes door sabotages) / Random |
| Skeld Vent Network                |                   Determines the pathing of the existing vent network.                   |   String   | Unchanged |                                  Unchanged / Quad-Group                                   |
| Themed Map Decor                  |                      Determines which decor is applied to the map.                       |   String   | Automatic |                   Automatic / No Decor / Birthday / Halloween / TV Show                   |
| Change Sabotage Timers            |                  Determines if the Sabotage countdowns are changed.                  |   Toggle   |   True    |                                       True / False                                        |
| ┣ Oxygen Sabotage Countdown       |                 Determines how long the O2 Sabotage countdown will last.                 |  Seconds   |    30s    |                                         15 - 90s                                          |
| ┗ Reactor Sabotage Countdown      |              Determines how long the Reactor Sabotage countdown will last.               |  Seconds   |    30s    |                                         15 - 90s                                          |
