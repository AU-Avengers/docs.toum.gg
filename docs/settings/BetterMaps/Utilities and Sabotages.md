...
| Tasks Are Checked on Portable Utils | Determines whether portable utils (Admin, Cams, Vitals) checks for the required task count before use. | Toggle |  True   | True / False |
