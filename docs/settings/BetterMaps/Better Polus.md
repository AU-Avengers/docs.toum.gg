...
<img src={useBaseUrl('/img/SettingIcons/Polus.png')} align="left" style={{ height: 65, marginRight: '12px' }} />
...
| Change Short Tasks Offset               |                     Determines if the Short Task count will be increased or decreased, and by how much.                     |   Count    |     0     |                                        -5 **-** 5                                         |
| Change Long Tasks Offset                |                     Determines if the Long Tasks count will be increased or decreased, and by how much.                     |   Count    |     0     |                                        -3 **-** 3                                         |
...
| Adjusted Polus Vent Network             |                            Determines if the path of the existing vents network is changed.                             |   Toggle   |   False   |                                       True / False                                        |
