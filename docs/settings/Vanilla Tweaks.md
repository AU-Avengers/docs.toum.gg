...
Settings to adjust the vanilla experience.
...
| Pet Removed on Body Clean             |                                    Determines if/when pets will be removed if a body is cleaned.                                     | String |  During Round  |       During Round / Always / Never       |
